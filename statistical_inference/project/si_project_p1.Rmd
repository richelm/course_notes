...
Below on the left is a historgram of a collection of 1000 random exponentials using $\lambda = 0.2$. It certainly does not appear to be normally distributed. The histogram to the right is that of our sample mean (**mean_distro**). It definitely has a Gaussian appearence. The dotted red line indicates the mean. As we can see, it is centered close to the theoretical mean of 5.
