...
To illustrate this further, we will take our distribution of means (**mean_distro**) and for each mean subtract off $\mu = 5$ and divide by our $SE = 5$. This will give us a standard normal distribution of our means. In the graph below this standard normal distribution of our means is compared with the standard normal curve. The histogram of mean fits quite nicely under the standard normal curve.
