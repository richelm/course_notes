...
This report, using the the mtcars data-set, examines the relationship among the variables in the data-set and miles per gallon (*mpg*) as outcome. Two main points addressed in this report are (1) whether an automatic or manual transmission results in better gas mileage and (2) what is difference in *mpg* between automatic and manual transmissions.
...
Variables *cyl*, *disp*, *hp*, and *wt* are highly correlated with **mpg**. The high correlation between *disp* and *cyl* indicates that those two should be examined and determine if both should be included. 
...
This shows that on average the is a **2.084** mile per gallon increase for a manual transmission over an automatic. The $R^2$ value show the model explains **84%** of the variation. 